...
# 后台IP设置
export Ipv4_ipaddr="10.0.0.10"            # 修改openwrt后台地址(填0为关闭)
...
export DNS_Settings="10.0.0.1,211.136.150.66"                     # 旁路由设置 DNS(填入DNS，多个DNS要用空格分开)(填0为不作修改)
export Broadcast_Ipv4="10.0.0.10"                   # 设置 IPv4 广播(填入您的IP为启用)(填0为不作修改)
